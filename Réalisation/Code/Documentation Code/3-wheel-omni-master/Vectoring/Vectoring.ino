...
void setup() {
  ...
  //encoder setup, 
  pinMode(encoder1PinA, INPUT); //Rend les encoder opérationnels
  ...
  //Lorque que l'necoder detecte un changement il declenche doEncoder1, qui fais quelque chose sur encoder1Pos
  ...
  attachInterrupt(digitalPinToInterrupt(20), doEncoder3, CHANGE);  // encoder pin on interrupt 20
  ...
  // Les timer devrait servire pour gerer les PWM
  cli(); // stop interrupts
  TCCR1A = 0; // set entire TCCR1A register to 0
  TCCR1B = 0; // same for TCCR1B
  // Initilisation du Timer1 pour les deux registres de controle A et B, les deux registres sont sur 8bit pour
  // avoir 16bit au final,  

  TCNT1  = 0; // initialize counter value to 0
  // set compare match register for 5 Hz increments
  // 
  // Le compteur est incrementer ou decrementer d'une unité a chaque top d'horloge 
